...
Define the behavior for a Chrome Manifest V3 recent-tab switcher extension that tracks recently active tabs per Chrome window and provides keyboard-driven switching.
